...
<head>
    ...
    <title>CryptoCamp by Raja</title>
</head>
                ...
                <div class="col-lg-11 col-12">
                    <div class="row">
                        <div class="col-lg-6 col-12 copywriting">
                            ...
                            <h1 class="header">
                                Deepening <span class="text-purple">Crypto <br> Knowledge</span> Today
                            </h1>
                            <p class="support">
                                Join Crypto Camp! Where cryptocurrency lovers deepen their
                                knowledge and skills with materials from industry experts. 
                                Start your immersive journey into the world of cryptocurrency with us!.
                            </p>
                            <p class="cta">
                                <a href="#" class="btn btn-master btn-primary">
                                    Get Started
